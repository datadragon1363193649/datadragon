...
# import web
import math
from bin.api.model.risk.user_info import CardId, CreditTask,UnioznpayTask,BehaviorTask,RiskUser
...
class AllfeatureFind(object):
    ...
    def __init__(self):
        ...
        self.db_sudaibear = create_engine(dconf.DB_USER_BASIC_INFO_SUDAIBEAR, encoding='utf-8', pool_recycle=30,poolclass=NullPool)
    ...
    def get_all_feature(self):
        ...
        init_file='/home/xuyonglong/feature/working/experiment/20170403/sample/phnotherad'
        userdic={}
        ...
        for phn in userdic:
            ...
            cf.update({'_id': phn}, {'$set': {'credit_behavior.application_platforms': application_platforms,
                                              'credit_behavior.application_pount': application_pount,
