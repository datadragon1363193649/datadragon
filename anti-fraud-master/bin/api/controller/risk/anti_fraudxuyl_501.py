    ...
    def get_phn_num_fea(self,cinfo):
        ...
        for c in call_details['call_info']:
            ...
            try:
                ...
                continue
        try:
            max_phn_num=time_frq[0][max(time_frq[0])]
        except:
            pass
        return [max_phn_num,user_all_num,user_no_ans_num]
...
if __name__ == '__main__':
    ...
    JKLOG.Initialize('111', fname="dltest", log_type=1, jk_log_level="efil",
                     ...
                     backcount=7)
    p1 = multiprocessing.Process(target=a.get_all_feature, args=('sudaiuid_phn.txt',))
