...
mg_hosty1 = '172.16.51.13:3717'
mg_hosty2 = '172.16.51.13:3717'
mg_replicat_set = 'test-risk'
mg_uname = 'xuyonglong'
mg_passwd = 'MDkoWEYN3YhBNJpNLyVksdZA'
mg_dby = 'risk'
mg_collection = 'cc_wx_lease_info'
...
config_path='/Users/ufenqi/Documents/dataming/score_card/parameter/'
model_path='/Users/ufenqi/Documents/dataming/score_card/model/'
# 列名文件名称
...
phn_type=['to_rent','goods_details','goods_parameter'
    ,'goods_reviews','confirm_order','risk_push','confirm_pay','login']
# 单独处理：goods_list_iphonex
goods_list='goods_list'
login_to_risk_num = 0
risk_to_order_num = 0
order_to_pay_num = 0
login_to_risk_duration = -1
risk_to_order_duration = -1
order_to_pay_duration = -1