...
def trainnum():
    ...
    with open(f_file, 'r') as fp:
        ...
        for line in fp:
            ...
            removelist=['19','20','36','37','38','43','45','54','46','47','48','49','50','51','55','56','57','58','59','60','61','62','63','64','65']
            linenew=linelist
            # linenew=linelist[8:]
            for ln in linenew:
...
def testnum():
    f_file = '/Users/ufenqi/Downloads/testfenxiang_codemax.csv'
    out_file = '/Users/ufenqi/Downloads/testnumbercntmax'
    wfp = open(out_file, 'w')
    with open(f_file, 'r') as fp:
        i1 = 0
        for line in fp:
    ...
    print train.dtypes
    # traindf.join(numdf,on=['userid','userid'])
    train.to_csv('/Users/ufenqi/Downloads/testnumbercntmax.csv', index=False)
