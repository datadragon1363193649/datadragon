...
fenxiangdict['27_1']=[[14],[13],[11],[9,10,8],[0],[7,4,1,6],[5,2,3]]
...
def traincode():
    f_file = '/Users/ufenqi/Downloads/traindfenxiang2.csv'
    ...
    del fdf['56_1']
    fdf.to_csv('/Users/ufenqi/Downloads/traindfenxiang_code.csv',index=False)
def testcode():
